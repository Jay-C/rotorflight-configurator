...
TABS.profiles.initialize = function (callback) {
    ...
    function data_to_form() {
        ...
        //$('.tab-profiles input[id="rescueMode"]').prop('checked', FC.PID_PROFILE.rescueMode !== 0);
        $('.tab-profiles input[id="rescueFlipMode"]').prop('checked', FC.PID_PROFILE.rescueFlipMode !== 0);
    ...
    function form_to_data() {
        ...
        FC.PID_PROFILE.rescueFlipMode = $('.tab-profiles input[id="rescueFlipMode"]').is(':checked') ? 1 : 0;
